      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-strong p-8">
          ...
          {sent ? (
            ...
            <form onSubmit={(e) => { e.preventDefault(); toast.success('Reset link sent (demo)'); setSent(true); }} className="mt-6 space-y-4">
              <input required type="email" className="input-field" placeholder="you@business.in" value={email} onChange={(e) => setEmail(e.target.value)} data-testid="forgot-email-input" />
              <button className="btn-primary w-full" data-testid="forgot-submit-button">Send reset link</button>
            </form>
          )}
